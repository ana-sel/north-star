 ...
 * lives in the journey_progress and journey_returns tables, not here.
 */
...
/** The V1 Browse surface. The complete 41-path catalogue remains below. */
export const V1_FEATURED_PATH_IDS = [
  'stillness', 'selfpossession', 'nonattachment', 'resilience', 'reciprocity',
  'courage', 'authority', 'warmth', 'seeing', 'grace', 'curiosity', 'agency',
  'shipping', 'play',
] as const;
...
export const DATA: Record<string, PathQuality> = {
  stillness:{
    ...
    ritual:null,
    practice:{
      what:'Pause before responding when you would normally react immediately',
      freq:'2\u20134\u00d7 / week',
      do:'In a moment where you would normally react immediately, pause before responding. Notice the impulse and make even a little space before you choose what to do.',
      counts:'You <b>noticed the impulse and created a small pause</b>. You do not need to feel calm.',
    },
    voice:{
  ...
  curiosity:{
    ...
    ritual:null,
    practice:{
      what:'Follow one genuine question into what you do not yet understand',
      freq:'2\u20134\u00d7 / week',
      do:'Follow one genuine question into something you do not yet understand before immediately judging, dismissing, or closing it. Investigate, ask, explore, or test.',
      counts:'You <b>genuinely investigated, asked, explored, or tested</b>. Not when you reach a final answer.',
    },
    tryPool:{
...
export const INTEGRATED = new Set<string>();

export const V1_PATH_CONTRACT: Readonly<Record<(typeof V1_FEATURED_PATH_IDS)[number], Pick<PathQuality, 'domain' | 'quality' | 'shows' | 'ritual' | 'practice'>>> = {
  stillness: { domain: 'Inward', quality: 'Stillness', shows: 'Pause before you react, not only after.', ritual: null, practice: { what: 'Pause before responding when you would normally react immediately', freq: '2-4x / week', do: 'In a moment where you would normally react immediately, pause before responding.', counts: 'You noticed the impulse and created even a small pause. You do not need to feel calm.' } },
  selfpossession: { domain: 'Inward', quality: 'Self-possession', shows: 'Stay yourself around someone you want to impress.', ritual: null, practice: { what: 'Say or do one thing that is genuinely yours', freq: '2-4x / week', do: 'Say or do one thing that is genuinely yours when you feel tempted to perform, impress, shrink, or become what someone else wants.', counts: 'You chose one authentic action, preference, or sentence.' } },
  nonattachment: { domain: 'Inward', quality: 'Non-attachment', shows: 'Want fully. Do not require the outcome.', ritual: null, practice: { what: 'Name what you are gripping and what remains yours', freq: '2-4x / week', do: 'Name the outcome you are gripping and name what remains yours even if you do not receive it.', counts: 'Both parts are named. Wanting does not need to disappear.' } },
  resilience: { domain: 'Inward', quality: 'Resilience', shows: 'Take the next action while it still stings.', ritual: null, practice: { what: 'Take one small useful next action after difficulty', freq: '2-4x / week', do: 'After disappointment, rejection, pain, or failure, take one small useful next action.', counts: 'The action happens. The pain does not need to be gone.' } },
  reciprocity: { domain: 'Together', quality: 'Reciprocity', shows: 'Notice whether it flows both ways.', ritual: null, practice: { what: 'Offer once, then leave space', freq: '2-4x / week', do: 'Offer once, then stop adding, chasing, or compensating long enough to observe whether the other side moves toward you.', counts: 'You allowed space for reciprocity rather than manufacturing it.' } },
  courage: { domain: 'Frontier', quality: 'Emotional Courage', shows: 'Say the true thing even when it exposes you.', ritual: null, practice: { what: 'Let one honest thing be visible', freq: '2-4x / week', do: 'Allow one genuine feeling, preference, need, or truth to be visible without hiding it behind a joke, apology, or unnecessary hedge.', counts: 'The honest thing becomes visible.' } },
  authority: { domain: 'Together', quality: 'Quiet Authority', shows: 'Say it once. Do not over-explain.', ritual: null, practice: { what: 'Say what you mean calmly', freq: '2-4x / week', do: 'Say what you mean calmly and resist the urge to produce a long defence after it.', counts: 'You state it clearly and allow it to stand.' } },
  warmth: { domain: 'Together', quality: 'Warmth', shows: 'People notice that you noticed them.', ritual: null, practice: { what: 'Express genuine warmth when it arises', freq: '2-4x / week', do: 'When genuine warmth arises, express it instead of keeping it inside.', counts: 'One sincere warm response, acknowledgement, or kindness is expressed.' } },
  seeing: { domain: 'Together', quality: 'Seeing People', shows: 'Taken in, not just responded to.', ritual: null, practice: { what: 'Ask the genuine second question', freq: '2-4x / week', do: "Ask the genuine second question and stay with the person's answer.", counts: 'You remain with their experience instead of immediately turning the conversation back to yourself.' } },
  grace: { domain: 'Together', quality: 'Grace', shows: 'Let people keep their dignity.', ritual: null, practice: { what: 'Preserve dignity without abandoning your boundary', freq: '2-4x / week', do: 'Where you could punish, embarrass, humiliate, score a point, or prove superiority, choose the response that preserves dignity without abandoning your own boundary.', counts: 'You remain self-respecting without unnecessary cruelty or humiliation.' } },
  curiosity: { domain: 'Frontier', quality: 'Curiosity', shows: 'Move toward what you do not understand.', ritual: null, practice: { what: 'Follow one genuine question into what you do not yet understand', freq: '2-4x / week', do: 'Follow one genuine question into something you do not yet understand before immediately judging, dismissing, or closing it.', counts: 'You genuinely investigate, ask, explore, or test.' } },
  agency: { domain: 'Craft', quality: 'Agency', shows: 'Look for the move you can make.', ritual: null, practice: { what: 'Identify one move under your control and make it', freq: '2-4x / week', do: 'Identify one move that is genuinely under your control and make it.', counts: 'A real action occurs.' } },
  shipping: { domain: 'Craft', quality: 'Shipping', shows: 'Put it in front of people before it feels perfect.', ritual: null, practice: { what: 'Put something imperfect in front of reality', freq: '2-4x / week', do: 'Put something imperfect in front of a user, customer, audience, application, listing, collaborator, or other real external feedback source.', counts: 'The thing leaves private preparation and meets reality.' } },
  play: { domain: 'Frontier', quality: 'Play', shows: 'For no reason other than it is fun.', ritual: null, practice: { what: 'Do something enjoyable without a productive outcome', freq: '2-4x / week', do: 'Do something because it is enjoyable, absorbing, or alive without requiring a productive outcome.', counts: 'The activity is allowed to be valuable without optimisation.' } },
};

for (const pathId of V1_FEATURED_PATH_IDS) {
  Object.assign(DATA[pathId], V1_PATH_CONTRACT[pathId]);
}
