...
MVP_AGENT_POLICIES: list[dict] = [
    ...
    },
    {
        ...
        "display_name": "Energy Agent",
        "can_read": ["energy_summary", "completion_stats"],
        "cannot_read": [
            "raw_bank_screenshots",
            "identity_documents",
            "diary_raw",
    ...
    },
    {
        ...
        "can_read": ["health_summary", "energy_summary"],
        "cannot_read": [
            "raw_bank_screenshots",
            "identity_documents",
            "diary_raw",
    ...
    {
        "agent_id": "money_agent",
        "display_name": "Money Agent",
        "can_read": ["money_summary"],
        "cannot_read": [
            "raw_bank_screenshots",
            "identity_documents",
            "diary_raw",
    ...
    },
    {
        ...
        "can_read": ["completion_stats", "card_titles"],
        "cannot_read": [
            "raw_bank_screenshots",
            "identity_documents",
            "diary_raw",
    ...
    },
    {
        "agent_id": "healing_agent",
        "display_name": "Healing Agent",
        "can_read": ["completion_stats", "card_titles", "health_summary", "energy_summary"],
        "cannot_read": [
            "raw_bank_screenshots",
            "identity_documents",
            "diary_raw",
    ...
    },
    {
        ...
        "can_read": ["completion_stats", "card_titles", "card_body"],
        "cannot_read": [
            "raw_bank_screenshots",
            "identity_documents",
            "diary_raw",
