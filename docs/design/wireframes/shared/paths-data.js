...
const STAGES = ['Watching','Doing','Under pressure'];
...
const AIMS = ['Freedom','Peace','Love','Aliveness','Mastery'];
const AIM_NOTE = {
...
/* Each domain already implies one aim — every Inward quality buys Peace,
   ...
   BEYOND its own home. */
const DOMAIN_AIM = { Inward:'Peace', Together:'Love', Craft:'Freedom', Frontier:'Aliveness' };
const extraAims = id => (SERVES[id] || []).filter(a => a !== DOMAIN_AIM[DATA[id].domain]);
...
let CORE = new Set(['selfpossession','solitude','nonattachment','boundaries','curiosity','creative','play','gratitude','courage','reciprocity','reinvention']);

/* Self-claimed, permanent, gold. Never re-offered in Browse: you cannot
   start something that has already become part of you. */
const INTEGRATED = new Set(['constancy','attention']);
